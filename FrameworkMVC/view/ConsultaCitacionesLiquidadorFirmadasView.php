...
<html lang="es">
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("ConsultaCitacionesLiquidador","consulta_liquidador"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12">
	         ...
	         <tr >
	            ...
	            <?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <a href="<?php echo $helper->url("ConsultaCitacionesLiquidador","abrirPdf"); ?>&id=<?php echo $res->id_citaciones; ?>" onclick="window.open(this.href, this.target, ' width=1000, height=800, menubar=no');return false" class="btn btn-success" onClick="Ok()" style="font-size:65%;">-- VER --</a>
		                </td> 
		    		</tr>
		        <?php } }  ?>
