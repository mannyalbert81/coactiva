	         ...
	         <tr >
	            ...
	            <?php if (!empty($resulSet)) {  foreach($resulSet as $res) {?>
	        		<tr>
			          ...
			          <td>
			           		<div class="right">
			                    <a href="<?php echo $helper->url("AvocoConocimiento","AvocoImpulsor"); ?>&id_juicios=<?php echo $res->id_juicios; ?>" class="btn btn-warning" onClick="notificacion()" style="font-size:75%;">--Seleccionar--</a>
			                </div>
		...
		<div class="col-xs-12 col-md-12" style="margin-top:10px; margin-bottom: 20px;">
		 <div class="form-group">
			  ...
			  <input type="submit" id="Guardar" name="Guardar" onclick="this.form.action='<?php  echo $helper->url("AvocoConocimiento","InsertaAvocoImpulsorDomPdf"); ?>'" value="Guardar" class="btn btn-success" />
			   ...
			   <div class="col-xs-6 col-md-6" style="text-align: center; margin-top:10px" >
			 <input type="submit" id="Visualizar" name="Visualizar" onclick="this.form.action='<?php echo $helper->url("AvocoConocimiento","VisualizaAvocoImpulsor_DomPdf"); ?>'" value="Visualizar" class="btn btn-info" />
			 </div>
