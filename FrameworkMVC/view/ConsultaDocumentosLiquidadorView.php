...
<html lang="es">
      ...
      <head>
        ...
        <meta charset="utf-8"/>
        <title>Firmar Documentos Liquidador - coactiva 2016</title>
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("ConsultaDocumentosLiquidador","consulta_liquidador"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12">
         
         <!-- comienxza busqueda  -->
         <div class="col-lg-12" style="margin-top: 10px">
         
       	 <h4 style="color:#ec971f;">Firmar Documentos Liquidador</h4>
		 ...
		 <input type="submit" value="Firmar" id="firmar" name="firmar" class="btn btn-info" onclick="this.form.action='index.php?controller=ConsultaDocumentosLiquidador&action=EnviarApplet'" style="margin-top: 10px;"/>
	            ...
	            <?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
	        		<tr>
	        		  ...
	        		  <td style="color:#000000;font-size:80%;"> <?php echo $res->id_documentos; ?></td>
		               ...
		               <a href="<?php echo $helper->url("ConsultaDocumentosLiquidador","abrirPdf"); ?>&id=<?php echo $res->id_documentos; ?>" onclick="window.open(this.href, this.target, ' width=1000, height=800, menubar=no');return false" class="btn btn-success" onClick="Ok()" style="font-size:65%;">-- VER --</a>
		               <a href="<?php echo $helper->url("ConsultaDocumentosLiquidador","rechazarPdf"); ?>&id=<?php echo $res->id_documentos; ?>" class="btn btn-danger" onClick="Ok()" style="font-size:65%;">Eliminar</a>
		               </td> 
		    		</tr>
		        <?php } }else {  ?>
