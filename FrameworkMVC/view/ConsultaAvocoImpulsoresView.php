...
<html lang="es">
      ...
      <head>
        ...
        <meta charset="utf-8"/>
        <title>Firmar Avoco Impulsores - coactiva 2016</title>
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("ConsultaAvocoImpulsores","consulta_impulsores_avoco"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12">
         
         <!-- comienxza busqueda  -->
         <div class="col-lg-12" style="margin-top: 10px">
         
       	 <h4 style="color:#ec971f;">Firmar Avoco Impulsores</h4>
	         ...
	         <tr >
	            ...
	            <?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <a href="<?php echo $helper->url("ConsultaAvocoImpulsores","abrirPdf"); ?>&id=<?php echo $res->id_avoco_conocimiento; ?>" onclick="window.open(this.href, this.target, ' width=1000, height=800, menubar=no');return false" class="btn btn-success" onClick="Ok()" style="font-size:80%;"> VER </a>
		               </td> 
		    		</tr>
		        <?php } }else {  ?>
