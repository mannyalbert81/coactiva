...
<html lang="es">
      ...
      <head>
        ...
        <meta charset="utf-8"/>
        <title>Consulta Avoco Impulsores Firmados - coactiva 2016</title>
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("ConsultaAvocoImpulsores","consulta_impulsores_avoco_firmados"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12">
         
         <!-- comienxza busqueda  -->
         <div class="col-lg-12" style="margin-top: 10px">
         
       	 <h4 style="color:#ec971f;">Consulta Avoco Impulsores Firmados</h4>
	            ...
	            <?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
	        		<tr>
	        		  ...
	        		  <td style="color:#000000;font-size:80%;"> <?php echo $res->id_avoco_conocimiento; ?></td>
		               ...
		               <a href="<?php echo $helper->url("ConsultaAvocoImpulsores","abrirPdf"); ?>&id=<?php echo $res->id_avoco_conocimiento; ?>" onclick="window.open(this.href, this.target, ' width=1000, height=800, menubar=no');return false" class="btn btn-success" onClick="Ok()" style="font-size:65%;">-- VER --</a>
		               </td> 
		    		</tr>
		        <?php } }else {  ?>
